package gameGraphics {
	...
	public class SecurityCheckUnitG extends Sprite {
		...
		// Preforms the upgrade functionality. Overriden by children.
		public function upgrade(type:Boolean = false):void {
			trace("Upgrade not implemented yet!");
		}
		
		// Shows the current upgrade text. Overridden by children.
		public function showUpgradeInfoText(type:Boolean = false):void {
			trace("No text available!");
		}
				
		// Returns the text for selling
		public function sellText():String {
			return ("Sells the current machine.");
		}
