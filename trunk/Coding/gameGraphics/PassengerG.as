	...
	public class PassengerG extends Sprite
	{
		...
		public function setLine(newLine:LineG)
		{
			...
			if(Airport.hasTicketChecker())
			{
				...
				AirportG.ticketChecker.sendPassengerToLine(this);

			}else // if(newLine is LineG)
			{
				
				 
				setTarg(newLine.station.x-AirportG.FLOOR_X-200,newLine.station.y-AirportG.FLOOR_Y+100);
