...
//trace("passArray #1: " + this.name + " " + passArray);		
		...
		// Sets the target PassContainer for the pass
		...
		public function killPass(val:int):void {
			this.removeChild(passArray[val]);
			passArray.splice(val, 1);
			
		}
		
		// Checks if the pass exists on floor
		public function isPassHere(pass:PassengerG):int {
			return (passArray.indexOf(pass));
		}
